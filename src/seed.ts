...
const seed = async () => {
  ...
  // 6. Create Activity Categories (exact descriptions from original site)
  ...
  // 7. Create Featured Projects (exact content from original site)
      ...
      description: {
        root: {
          ...
          children: [
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'The project operates with a well-coordinated system involving experienced divers, local fishermen, surfers, and land volunteers to manage and process marine waste effectively. We host educational workshops and activities that raise awareness about marine pollution and inspire participants to become advocates for ocean conservation.' }],
            },
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'By engaging the public, the Underwater Caretakers project not only benefits the environment but also strengthens community involvement and corporate social responsibility.' }],
            },
          ],
        },
      },
      ...
      description: {
        root: {
          ...
          children: [
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'This project unites countries across the world on the same day, same time, fostering global collaboration for a shared cause \u2013 environmental stewardship. Our aim is to involve diverse communities, raising awareness about environmental issues, and inspiring lasting change.' }],
            },
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'By inviting NGOs, volunteers, and environmentalists from various nations we showcase the power of collective action and emphasize that environmental challenges know no borders.' }],
            },
          ],
        },
      },
      ...
      description: {
        root: {
          ...
          children: [
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'Tragically, discarded single-use plastic bottles often find their way into rivers and oceans, where they stubbornly persist for approximately 400 years, breaking down into toxic micro-plastics.' }],
            },
            {
              type: 'paragraph',
              children: [{ type: 'text', text: 'We identified a crucial battleground for change: events! Whether it be playful gatherings, sports spectacles, or vibrant music festivals, the problem of single-use plastic water bottles remains prevalent. By ingeniously transforming disposable waste into captivating art, we are aiming to send a resounding message of awareness against single-use plastics and the pressing need for reuse.' }],
            },
          ],
        },
      },
  ...
  // 8. Create Volunteer Leaders (exact names and locations from original site)
        ...
        content: {
          root: {
            ...
            children: [
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'The second edition of Underwater Caretakers was a resounding success, bringing together our largest team yet for an underwater and coastal cleanup operation. Experienced divers worked alongside local fishermen, surfers, and land volunteers in a coordinated effort to remove debris from the ocean floor and coastline.' }],
              },
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'Together, we removed over 200kg of waste including fishing nets, plastic bottles, tires, and other debris that threatened marine life. This event demonstrates the power of community collaboration in protecting our oceans.' }],
              },
            ],
          },
        },
  ...
  // =============================================
  // 10. Update ALL Globals with real website content
  // =============================================
  ...
  await payload.updateGlobal({
    ...
    data: {
        ...
        content: {
          root: {
            ...
            children: [
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'D\u00e9bora S\u00e1, a Network Management Technician and Yoga Instructor based in Costa da Caparica, discovered her environmental calling through childhood involvement with the Portuguese Scouts, where she learned the importance of respecting the environment.' }],
              },
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'Her journey to founding the organization developed gradually rather than through a single pivotal moment. In early 2020, a planned three-month Brazil trip extended to six months due to COVID-19. During this period, she helped a poor community on Itaparica Island, mobilizing Portuguese friends to fundraise for basic necessities. This experience demonstrated the power of collective action and planted the seeds for Planet Caretakers.' }],
              },
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'Upon returning to Portugal, D\u00e9bora organized a cleanup at Fonte da Telha. Despite modest initial turnout, she expanded recruitment for subsequent events. This momentum led to creating Planet Caretakers as a platform for environmentally passionate individuals. The initiative grew substantially, forming 25 active teams conducting 300 cleanups that removed 44 tons of waste over three years.' }],
              },
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'Planet Caretakers aims to build a global network of environmental stewards, inspiring individuals to take action in preserving the planet.' }],
              },
            ],
          },
        },
      ...
      teamSection: {
        heading: 'Our Team',
        description: 'Meet the passionate people behind Planet Caretakers.',
      },
    } as any,
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      hero: {
        heading: 'Activities',
        subtitle: 'Planet Caretakers promotes and participates on a diverse range of activities.',
        backgroundImage: actBeach?.id || null,
      },
  ...
  await payload.updateGlobal({
    ...
    data: {
      hero: {
        heading: 'Our Team',
        subtitle: "Choosing eco-friendly isn't just a choice; it's a commitment to a brighter, greener tomorrow.",
        backgroundImage: heroTeamwork?.id || null,
      },
      portugalSection: { heading: 'Portugal Team Leaders' },
      worldwideSection: { heading: 'Worldwide Leaders' },
      recruitmentCta: {
        heading: 'Want to get involved?',
        description: 'Together, we can turn awareness into action \u2014 starting right now.',
        button: { label: 'Become a Volunteer', url: '/contact' },
      },
    } as any,
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      hero: {
        heading: 'Causes',
        subtitle: "Choosing eco-friendly isn't just a choice; it's a commitment to a brighter, greener tomorrow.",
        backgroundImage: heroSaveWorld?.id || null,
      },
      partnershipPitch: {
        heading: "Let's Take Action",
        content: {
          root: {
            type: 'root',
            children: [
              {
                type: 'paragraph',
                children: [{ type: 'text', text: 'Speak up and take action for nature, for a sustainable future. Be the brand that acts \u2014 not just talks. Join us in restoring the planet.' }],
              },
            ],
          },
        },
      ...
      cta: {
        heading: 'When we act together, help becomes healing.',
        description: 'Every effort \u2014 big or small \u2014 creates ripples of change.',
  ...
  await payload.updateGlobal({
    ...
    data: {
      hero: {
        ...
        subtitle: 'Want to become a volunteer or looking for a partnership?',
      },
      contactInfo: {
        address: 'Sobreda, Portugal',
        email: 'info@planetcaretakers.org',
        phone: '+351 960 238 484',
        officeHours: 'Mon-Fri: 09am-07pm\nSat-Sun: Closed',
      },
    } as any,
  })
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      defaultSeo: {
        ...
        description: 'Planet Caretakers is a nonprofit organization dedicated to environmental cleanups and conservation worldwide.',
      },
      ...
      socialLinks: {
        instagram: 'https://instagram.com/planetcaretakers',
        facebook: 'https://facebook.com/planetcaretakers',
        linkedin: 'https://linkedin.com/company/planetcaretakers',
        youtube: 'https://youtube.com/@planetcaretakerss',
      },
    } as any,
  })
